...
class CoreXMLParserStandardFeedTest {
    ...
    fun channelTitle_isCorrect() {
        assertEquals("Android Authority", channel.title)
    }

    @Test
    fun channelDesc_isCorrect() {
        assertEquals("Android News, Reviews, How To", channel.description)
    }

    @Test
    fun channelLink_isCorrect() {
        assertEquals("https://www.androidauthority.com", channel.link)
    }
    ...
    fun channelLastBuild_isCorrect() {
        assertEquals("Wed, 15 May 2019 20:48:02 +0000", channel.lastBuildDate)
    }
    ...
    fun title_isCorrect() {
        assertEquals(
            "Japan’s plans for 5G include 10 billion 14-digit phone numbers",
            article.title
        )
    }
    ...
    fun author_isCorrect() {
        assertEquals("Williams Pelegrin", article.author)
    }
    ...
    fun link_isCorrect() {
        assertEquals(
            "https://www.androidauthority.com/japan-phone-numbers-14-digits-5g-986823/",
            article.link
        )
    }
    ...
    fun pubDate_isCorrect() {
        assertEquals("Wed, 15 May 2019 20:48:02 +0000", article.pubDate)
    }
    ...
    fun description_isCorrect() {
        assertEquals(
            "Japan expects a huge surge of 5G-enabled devices to hit the market in the future.",
            article.description
        )
    }
    ...
    fun image_isCorrect() {
        assertEquals(
            "https://cdn57.androidauthority.net/wp-content/uploads/2019/02/Whats-next-with-5g--500x260.jpg",
            article.image
        )
    }
    ...
    @Throws
    fun guid_isCorrect() {
        assertEquals("https://www.androidauthority.com/?p=986823", article.guid)
    }
