...
class CoreXMLParserFirstLineEmptyTest {
    ...
    fun channelImage_isNull() {
        assertEquals("https://www.cnj.jus.br/wp-content/uploads/2020/06/Favicons-Portal-CNJ-1-36x36.jpg", channel.image!!.url)
    }
    ...
    @Throws
    fun link_isCorrect() {
        assertEquals("https://www.cnj.jus.br/tj-e-premiado-em-evento-nacional-sobre-inovacao-e-direito-para-o-ecossistema/?utm_source=rss&utm_medium=rss&utm_campaign=tj-e-premiado-em-evento-nacional-sobre-inovacao-e-direito-para-o-ecossistema", article.link)
    }
    ...
    fun description_isCorrect() {
        assertEquals("<p>O Tribunal de Justiça de Mato Grosso (TJMT) recebeu o prêmio destaque do Expojud online, Congresso de Inovação, Tecnologia e Direito para o Ecossistema da Justiça realizado de dois a quatro de junho. O Judiciário estadual foi condecorado na categoria Maior Participação de Instituição de Justiça. “Esse reconhecimento mostra que estamos no melhor caminho e [&#8230;]</p>\n" +
                "<p>The post <a rel=\"nofollow\" href=\"https://www.cnj.jus.br/tj-e-premiado-em-evento-nacional-sobre-inovacao-e-direito-para-o-ecossistema/\">TJ é premiado em evento nacional sobre inovação e direito para o ecossistema</a> appeared first on <a rel=\"nofollow\" href=\"https://www.cnj.jus.br\">Portal CNJ</a>.</p>", article.description)
    }
    ...
    fun content_isCorrect() {
        assertEquals("<p>O Tribunal de Justiça de Mato Grosso (TJMT) recebeu o prêmio destaque do Expojud online, Congresso de Inovação, Tecnologia e Direito para o Ecossistema da Justiça realizado de dois a quatro de junho. O Judiciário estadual foi condecorado na categoria Maior Participação de Instituição de Justiça. “Esse reconhecimento mostra que estamos no melhor caminho e certifica o trabalho que vem sendo desenvolvido no nosso tribunal. Tudo isso é fruto dos investimentos e do planejamento estratégico traçado de forma contundente na administração do desembargador Carlos Alberto Alves da Rocha”, frisa Luiz Octávio Oliveira Sabóia Ribeiro, juiz auxiliar da Presidência do TJMT.</p>\n" +
                ...
                "<p>The post <a rel=\"nofollow\" href=\"https://www.cnj.jus.br/tj-e-premiado-em-evento-nacional-sobre-inovacao-e-direito-para-o-ecossistema/\">TJ é premiado em evento nacional sobre inovação e direito para o ecossistema</a> appeared first on <a rel=\"nofollow\" href=\"https://www.cnj.jus.br\">Portal CNJ</a>.</p>", article.content)
    }
