...
internal enum class RssKeyword(val value: String) {
    ...
    companion object {
        ...
        /**
         * Validates and returns the RssKeyword for the given string value.
         * @param value the string value to validate
         * @return the corresponding RssKeyword if valid, null otherwise
         */
        fun fromValue(value: String): RssKeyword? {
            return valueMap[value.lowercase()]
        }

        /**
         * Checks if the given string value is a valid RSS keyword.
         * @param value the string value to validate
